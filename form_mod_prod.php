...
<body>
  ...
  <div class="panel panel-primary " style="margin-top: 60px;">
    ...
    <form method="post" action="update_produit.php" class="form" style="height:90%" >
      


    <div class="form-group">
     
      <input type="hidden" name="id"  class="form-control" required="required" max-length="20" value="<?php echo $idp ?>">
  ...
  <div class="form-group">
    ...
    <input type="text" name="prix" placeholder="Prix du produit" class="form-control" required="required" value="<?php echo $prix ?>">
  </div>

  <div class="form-group">
    <label for="quantite">quantite:</label>
    <input type="text" name="quantite" placeholder="quantite" class="form-control" required="required" value="<?php echo $quantite ?>">
  </div>   
